<x-admin.layout title="Blog Posts">
    ...
    <!-- Bulk Actions -->
    <form id="bulkForm" action="{{ route('admin.posts.bulk-action') }}" method="POST">
        @csrf
                ...
                <x-admin.table.row>
                            ...
                            <div class="flex-shrink-0 h-12 w-12 mr-4">
                                ...
                                @else
                                    <div class="h-12 w-12 rounded-lg bg-gray-200 flex items-center justify-center">
                                        <x-admin.icon name="file-text" class="w-6 h-6 text-gray-500" />
                                    </div>
                                @endif
                            </div>
                            <div>
                    ...
                    <x-admin.table.cell>
                        ...
                        @if($post->published_at && $post->published_at > now())
                            <span class="text-xs text-yellow-600 ml-1">(Scheduled)</span>
                        @endif
                    </x-admin.table.cell>
                    ...
                    <x-admin.table.cell>
                        <div class="text-sm text-gray-900">{{ $post->views }}</div>
                    ...
                    <x-admin.table.cell>
                        ...
                        @if($post->published_at)
                            <div class="text-xs text-gray-500">{{ $post->published_at->format('h:i A') }}</div>
                        @endif
                    </x-admin.table.cell>
            ...
            @empty
                <tr>
                    <td colspan="7" class="px-6 py-8 text-center text-gray-500">
                        <x-admin.icon name="file-text" class="w-12 h-12 mx-auto text-gray-400 mb-4" />
                        <p class="text-lg font-medium text-gray-900 mb-2">No posts found</p>
